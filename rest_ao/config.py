...
class RESTConfig:
    ...
    question_batch_size: int = 256  # Batch size for question generation (H100 80GB)
    grow_batch_size: int = 256  # Batch size for GROW phase (H100 80GB)
    judge_batch_size: int = 256  # Batch size for SCORE phase (H100 80GB)
